...
//        metadataString
//                .append(collector._path.getParent().getFileName()).append(internalSeparator)
//                .append(collector._path.getFileName()).append(internalSeparator).append(collector.START_LINE)
//                .append(internalSeparator).append(collector.END_LINE);
...
//        line.append(metadataString).append(externalSeparator).append(metricString);
        line.append(metricString);
        MainApplication.mem = line.toString();
        MainApplication.status = 1;
    }
